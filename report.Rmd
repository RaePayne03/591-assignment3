...
caption_4 <- 'Figure 1.PCA Variance, the barchart represents the variance explained by each individual prinicpal components along with a scatterplot that displays the cumulative sum of the variance explained across all principal components.' 
caption_5 <- 'Figure 2. Principal Component Analysis for the first two PCs which represent the first and second most amounts of variance in the data.' 
caption_8 <- 'Figure 3. Heat map representing normalized intensity values for differentially expressed probes based on expression values.Each row represents a probe and each column represents a sample. The colour and intensity of the boxes is used to represent changes of gene expression.'
```
